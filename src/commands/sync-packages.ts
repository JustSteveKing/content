...
export async function syncPackagesCommand() {
  ...
  async function getPackageDetails(packageName: string): Promise<any> {
  ...
  function buildMarkdown(pkg: any, readme: string | null): string {
